-- Habilitar extension pgcrypto si no está activa
...
BEGIN
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'devys1512@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('javier0001', gen_salt('bf')),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'enithyabeth@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('yaneth001', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'jeimersabogal179@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jeimer2741', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'mejorvision2024@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ruth2304', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sorgoguz@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('guz2680', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'odelgadillo@grupomunkel.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('olga489', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'todogafas.gt@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('lopez2316', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opt.henry.canar@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('henry2478', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'cbalbi@opticagiras.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('claudio2621', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'fernandotc1960@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('fernando1960', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'avelinoayos@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ayos0605', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'contabilidad@visioncentergroup.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('daynan800', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'jfavotto@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('julio1795', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'joseesquivel2003@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jose1060', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'mariletlopez@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('otto2039', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'serviciosopticosmelch@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('dormes2718', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticplanes@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('conrado2145', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'jairopoz1690@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jairo2713', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'salvavenezuela@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('salvatore1457', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opolicentroparquelefevre@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('policentro901', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'moncada.mariana@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Mariana1367', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'optica_optivisual@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('francisco1610', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ventas@grupoes-optico.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('solano2734', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'aliriogacia1966@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('garcia2418', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'hperez.quimcosta@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('perez02', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'aracely-garcia5@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('garcia1964', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'marcasyanteojossas@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jose003', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'exielop@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('lopez2341', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'johnnyegonzalez86@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('johnny1474', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'griselcordero@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('cordero1746', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ioni@homeofbrands.net';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('bach123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sebastianpaesani@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('paesani123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'varielmejia@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('mejia2672', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'neovision_2008@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('carreño2591', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'visiongloblal@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('guevara2093', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ortega.lester@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ortega2229', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'juliocesar@opticaoviedo.net';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('julio1969', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'zulivan72@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('zorrilla2714', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'cvmasopticacr@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('katia2674', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'manuluna82@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('luna2482', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'optinao@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('reyes0004', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sotozmy@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('sotozmy', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'exit.elsalvador@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('juan436', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'oscareuclides@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('martinez765', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticaoptiverca@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('perez2448', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'dclm.asistenciavisual@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('castillo2450', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticaquepos10@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('lorna2187', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'dikaoluciana@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('dicao0005', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'margotmonasterio@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('margot1667', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'guidotoapant@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('guido2361', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ulises.arreaga@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ulises1924', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'miguelkl73@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('mike25', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'contagjtrade@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jordi798', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'glenisalvaradom@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('alvarado2419', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'rgamacu@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ruth2697', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'distvenecia@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('granado748', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'eguerrero.tladd@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('guerrero2695', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'rodolfojimenezsaenz@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('rodolfo2742', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticavisionsantander@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Nidia2696', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'jimca_82@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jimmy710', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'fredy_p870@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('fredy2221', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'gerencia@grupocolors.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('giovani1499', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'dyrro1@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('liliana2563', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticaibarra@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ibarra2126', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'suoptica1990@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('murillo2707', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'mariajardi@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('maria2274', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sandracontreras81@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('sandra1884', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'alibellpg23@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('pulido2255', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'lymoncadarodriguez@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('moncada0006', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'danieldelgadosjm@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('delgado0007', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'centro.ocular0501@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('alfaro2281', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'jpulido1978@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('juan0008', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'gerentegeneral.almanzar@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('joga0008', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'villaroptica@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('villar0009', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'clinicaopticadelahoz@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Delahoz123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'tecnogafas@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Tecno123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'info@eyecarecanterpanama.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Eyecare123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sandoval.olga@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Totalvision123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'visionpluspty@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Visionplus123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'astrithc27@outlook.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Ojitos123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'optica@clinicayee.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Medi123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ojo.cliente@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Ojo123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'thompson.jose@imperial.com.pa';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Boyd123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticavistoso@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('vistoso123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'cliopt@clinicacliopt.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('Cliopt2608', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'desperategossip@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('marco0010', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'carldavidbarrientos.31@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('carlos2759', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'mauricio_santos31@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('mauricio2421', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'solano07hum@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('solano2751', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'consultaopticacenteno@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('centeno1760', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'stylos_opticos@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('vanessa2168', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'saludvisual@cwpanama.net';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('palma0011', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'sebastianmoradiaz.64@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('sebastian2334', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'lourdes_visionintegral1970@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('lourdes1920', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'cosmolens3@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('cesar792', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'gerencia@clinicaocularcr.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jorge888', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'paginaweb@opticasdeluxe.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('rocio123', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'grupoopticovision2020@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('omaira1280', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'diazoptica9@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('diaz0015', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticaberlud@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('bladimir1274', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticakors@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('fernando0000', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'luzoptical@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('omar1298', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'gioreoptical@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('claudia2560', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'williamscuadroc@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('alberto1509', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticasbethel@yahoo.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('kenny1480', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'veira2106@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('jusavi1928', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'pedroceleopti@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('pedro0018', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'lanita983@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ana1633', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'ccharpentier1978@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('christian1550', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'fatimacarolina_85@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('fatima1970', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'hdaguero@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('hector2153', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'visioneimagen@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('carlos2140', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'johaaram72@yahoo.es';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('ramirez2584', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'andressgiralt@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('andres1917', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'multiopticascr@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('miguel2110', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'opticlinic.cr@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('katherine2193', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'multiprofcc@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('chacon2438', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'recepcion@opticalook.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('harold1822', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'tanya_monge@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('tanya2059', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'yuditbelr@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('aguila0020', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'marioparrado01@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('parrado0021', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'info@servilentesgt.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('LauraOrrego', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'somarriba_mara09@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('somarriba0021', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'corpovision_11@hotmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('fernando0022', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'edgararcea@gmail.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('edgar1392', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'samir.traverso@opticasantalucia.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('traverso2197', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
  ...
  SELECT id INTO v_user_id FROM auth.users WHERE email = 'm.shoshan@kvr-partners.com';
  IF v_user_id IS NOT NULL THEN
    -- Actualizar contraseña y confirmación de correo si ya existe
    UPDATE auth.users
    SET encrypted_password = crypt('moshe0022', gen_salt('bf')),
        email_confirmed_at = COALESCE(email_confirmed_at, now()),
