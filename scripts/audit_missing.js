const users = [
  ...
  { code: "2357", country: "VENEZUELA", name: "MARBELLA SOTO", email: "sotozmy@gmail.com", password: "soto2357" },
  ...
  { code: "2450", country: "VENEZUELA", name: "MARCOS CASTILLO", email: "dclm.asistenciavisual@gmail.com", password: "2450" },
  ...
  { code: "2438", country: "El Salvador", name: "JAYRO CHACON", email: "multiprofcc@hotmail.com", password: "chacon 2438" },
...
console.log("=== 1. USUARIOS SIN CÓDIGO O CON CÓDIGO 0000 / GENÉRICO ===");
const missingCode = users.filter(u => !u.code || u.code === '0000' || u.code === '000' || u.code === '123');
missingCode.forEach(u => {
  console.log(`- ${u.name} | ${u.email} | País: ${u.country || 'N/A'} | Código actual: ${u.code || 'SIN CÓDIGO'}`);
});

console.log("\n=== 2. USUARIOS CON CONTRASEÑA CORTA (< 6 CARACTERES) O FORMATO ESPECIAL ===");
const shortPwd = users.filter(u => !u.password || u.password.length < 6 || u.password.includes(' '));
shortPwd.forEach(u => {
  console.log(`- ${u.name} | ${u.email} | Contraseña en PDF: "${u.password}" (${u.password.length} caracteres)`);
});
