  ...
  if (selectedOrder) {
    return (
      <div style={{ backgroundColor: '#FFF', padding: '2rem', borderRadius: 'var(--radius-md)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '2rem', textAlign: 'center' }}>Listado de pedidos:</h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem', borderBottom: '1px solid var(--border-light)', paddingBottom: '1rem' }}>
          ...
          >
            <ArrowLeft size={18} /> Orden de: {selectedOrder.clientName} email: {selectedOrder.clientEmail}
          </button>
          
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <button className="btn-primary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem' }}><Download size={14} style={{ display: 'inline', marginRight: '0.3rem' }}/> Descargar CSV</button>
            <button className="btn-primary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem' }}><Printer size={14} style={{ display: 'inline', marginRight: '0.3rem' }}/> Imprimir</button>
            <button className="btn-primary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem' }}>Validar productos</button>
            <button className="btn-secondary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem', backgroundColor: '#E0E7FF', color: 'var(--blue)', border: 'none' }}>Cliente validado</button>
            <button className="btn-secondary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem', backgroundColor: '#E0E7FF', color: 'var(--blue)', border: 'none' }}>Pedido creado</button>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#F8FAFC', padding: '1rem', borderRadius: 'var(--radius-md)', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: '#0CA5A5', fontWeight: 600, fontSize: '0.9rem' }}>
              ...
              <span>Este pedido ya se encuentra ordenado en switch</span>
            </div>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>Ordenado en:</span>
              <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>{selectedOrder.date}</span>
            </div>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>Subtotal:</span>
              <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>${selectedOrder.subtotal.toFixed(2)}</span>
            </div>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>Número de artículos:</span>
              <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>
                {selectedOrder.items.reduce((acc, item) => acc + item.quantity, 0)}
              </span>
            </div>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: '#0CA5A5' }}>Número de pedido switch:</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>Filtrar por estado</span>
              <select style={{ padding: '0.3rem', fontSize: '0.8rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--border-medium)' }}>
                <option>Choose an option...</option>
              </select>
            </div>
            <div>
              <span style={{ display: 'block', fontSize: '0.7rem', color: 'var(--text-tertiary)' }}>Número de orden:</span>
            ...
            <div key={idx} style={{ display: 'flex', gap: '1.5rem', paddingBottom: '1.5rem', borderBottom: '1px solid var(--border-light)' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Precio:</span>
                  ...
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Tamaño:</span>
                    <span style={{ display: 'inline-block', backgroundColor: '#0B2347', color: '#FFF', padding: '0.2rem 0.6rem', borderRadius: '1rem', fontSize: '0.75rem', fontWeight: 600 }}>
                      {item.product.eyeSize}
                    </span>
                  </div>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Material:</span>
                  ...
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Venta por:</span>
                    <span style={{ display: 'inline-block', backgroundColor: '#0B2347', color: '#FFF', padding: '0.2rem 0.6rem', borderRadius: '1rem', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase' }}>
                      {item.product.saleType}
                    </span>
                  </div>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Requerido por el cliente:</span>
                    <span style={{ display: 'inline-block', backgroundColor: '#0B2347', color: '#FFF', padding: '0.2rem 0.6rem', borderRadius: '1rem', fontSize: '0.75rem', fontWeight: 600 }}>
                      {item.quantity}
                    </span>
                  </div>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: 'var(--text-tertiary)' }}>Estado Inventario ERP:</span>
                    <span style={{ display: 'inline-block', backgroundColor: '#0B2347', color: '#FFF', padding: '0.2rem 0.6rem', borderRadius: '1rem', fontSize: '0.75rem', fontWeight: 600 }}>
                      Disponible
                    </span>
                  </div>
  ...
  return (
    <div style={{ backgroundColor: '#FFF', padding: '2rem', borderRadius: 'var(--radius-md)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)' }}>
      ...
      <div style={{ display: 'flex', gap: '2rem', marginBottom: '1.5rem' }}>
        <div>
          <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-secondary)', marginBottom: '0.3rem' }}>Filtrar por estado</span>
        ...
        <div>
          <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-secondary)', marginBottom: '0.3rem' }}>Filtrar por fecha</span>
          <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <span style={{ display: 'block', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                    Número de pedido switch: <br/><strong style={{ color: '#0CA5A5' }}>{order.switchOrderNumber}</strong>
                  </span>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '2rem' }}>
                <div>
                  <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Ordenado en:</span>
                  <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>{order.date}</span>
                </div>
                <div>
                  <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Subtotal:</span>
                  <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>${order.subtotal.toFixed(2)}</span>
                </div>
                <div>
                  <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Estado de pedido:</span>
              ...
              <div style={{ textAlign: 'right' }}>
                <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Número de orden:</span>
                <span style={{ display: 'block', fontSize: '1rem', fontWeight: 700, marginBottom: '0.5rem' }}>{order.orderNumber}</span>
                <button className="btn-primary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem' }} onClick={(e) => e.stopPropagation()}>Descargar CSV</button>
              </div>
            </div>

            <div style={{ display: 'flex', gap: '3rem', paddingTop: '1rem', borderTop: '1px solid var(--border-light)' }}>
              <div>
                <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Número de artículos:</span>
                <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>{order.items.reduce((acc, item) => acc + item.quantity, 0)}</span>
              </div>
              <div>
                <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Cliente:</span>
                <span style={{ fontSize: '0.85rem', fontWeight: 600 }}>{order.clientEmail}</span>
              </div>
              <div>
                <span style={{ display: 'block', fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Código Cliente:</span>
