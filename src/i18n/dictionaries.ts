export const dictionaries = {
  ...
  es: {
    ...
    'footer.phone': 'T: +507 4414731',
    'footer.address': 'Colón- Zona Libre, Ave. Dominador Bazan Calle 18 Edfi Atlantic Plaza Local 3B, Panamá',
    'footer.whatsapp1': '(+507) 6292-6554',
    'footer.whatsapp2': '(+507) 6291-2194',
    'footer.email': 'ventas@dubros.com',
    ...
    'footer.subscribe': 'Suscribirme ahora',
